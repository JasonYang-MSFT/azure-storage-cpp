...
namespace azure { namespace storage {
    ...
    private:
        ...
        WASTORAGE_API pplx::task<bool> exists_async(bool primary_only, const blob_request_options& options, operation_context context);
        WASTORAGE_API pplx::task<void> download_range_to_stream_parallel_async(concurrency::streams::ostream target, utility::size64_t offset, utility::size64_t length, const access_condition& condition, const blob_request_options& options, operation_context context);
