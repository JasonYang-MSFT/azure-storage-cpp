...
namespace azure { namespace storage {
    ...
    private:
        ...
        pplx::task<void> download_range_to_stream_parallel_async(concurrency::streams::ostream target, utility::size64_t start_offset, utility::size64_t length, const file_access_condition& access_condition, const file_request_options& options, operation_context context) const;
